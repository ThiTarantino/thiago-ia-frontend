...
// ─────────────────────────────────────────────────────────────────────────────
// GaleriaPainelBase — versão padronizada/reutilizável do GaleriaPainel.
// A UI e o CSS são os mesmos para todos os chats; as fotos são passadas por
// prop por cada chat (ex: galeriaMae.ts).
// ─────────────────────────────────────────────────────────────────────────────
...
export default function GaleriaPainelBase({ onClose, fotos, titulo = "Fotos e vídeos" }: Props) {
