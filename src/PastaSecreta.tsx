...
const PASTAS: Record<PastaId, { label: string; cor: string; icone: ReactNode; arquivos: Arquivo[] }> = {
  fotos: {
    ...
    arquivos: [
      { id: "f1", nome: "nossa_foto_1.jpg",    tipo: "foto", tamanho: "2.4 MB", data: "12/02/2025", src: "/imagens/foto1.jpg" },
      { id: "f2", nome: "nossa_foto_2.jpg",    tipo: "foto", tamanho: "1.8 MB", data: "14/03/2025", src: "/imagens/foto2.jpg" },
      { id: "f3", nome: "selfie_especial.jpg", tipo: "foto", tamanho: "3.1 MB", data: "01/05/2025", src: "/imagens/foto3.jpg" },
    ],
  },
  emails: {
    label: "E-mails",
    ...
    arquivos: [
      {
        ...
        conteudo: "Bela,\n\nNão sou muito bom com palavras, mas hoje precisava escrever isso.\n\nDesde que você entrou na minha vida, tudo ficou mais colorido — até o código parece mais bonito. Cada mensagem sua de bom dia é o melhor push da minha existência.\n\nObrigado por ser minha parceira, minha melhor amiga e o amor da minha vida.\n\nCom todo meu amor,\nThiago 💙",
      },
      {
        id: "e2",
        ...
        conteudo: "Querida Bela,\n\n01. Seu sorriso quando você acha graça de algo bobo.\n02. A forma como você faz tudo parecer mais leve.\n03. Sua teimosia (sim, até isso).\n04. Como você se importa com as pessoas.\n05. O jeito que você diz meu nome.\n06. Cada conversa de madrugada que não quero que acabe.\n07. Você.\n\n— Thiago",
      },
    ],
  },
  mensagens: {
    ...
    arquivos: [
      {
        id: "m1",
        nome: "primeiro_oi.txt",
        tipo: "mensagem",
        tamanho: "1 kB",
        data: "01/01/2025",
        conteudo: "[ 01/01/2025 • 23:47 ]\n\nEu: Oi 👋\nBela: Oi! Quem é você? haha\nEu: Alguém que vai te fazer muito feliz.\nBela: Nossa, que ousado 😂\nEu: Espera só um pouco pra ver...\n\n────────────────────\nO começo de tudo. 🤍",
      },
      {
        id: "m2",
        nome: "madrugada_memoravel.txt",
        tipo: "mensagem",
        tamanho: "2 kB",
        data: "15/02/2025",
        conteudo: "[ 15/02/2025 • 02:13 ]\n\nEu: você ainda tá acordada?\nBela: sim, não consigo dormir\nEu: eu também não, fica comigo mais um pouco?\nBela: já tô aqui né 🥺\nEu: é que às vezes preciso ter certeza que você é real\nBela: sou sim, idiota 💙\nEu: o melhor tipo de real\n\n────────────────────\nEssa noite ficou guardada pra sempre. 🌙",
      },
      {
        id: "m3",
        nome: "te_amo_de_verdade.txt",
        tipo: "mensagem",
        tamanho: "1 kB",
        data: "10/04/2025",
        conteudo: "[ 10/04/2025 • 19:32 ]\n\nEu: posso te falar uma coisa?\nBela: pode\nEu: eu te amo. de verdade.\nBela: ...\nBela: eu também te amo, seu tonto 💚\n\n────────────────────\nAs palavras mais importantes que já escrevi. 💚",
      },
    ],
  },
};
