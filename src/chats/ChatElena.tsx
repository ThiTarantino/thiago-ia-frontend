...
const FOTOS = [
  "/imagens/mae/foto1.jpg",
  "/imagens/mae/foto2.jpg",
  "/imagens/mae/foto3.jpg",
  "/imagens/mae/foto4.jpg",
  "/imagens/mae/foto5.jpg",
  "/imagens/mae/foto6.jpg",
...
// App principal
// ─────────────────────────────────────────────────────────────────────────────
export default function ChatMae({
  onBack,
  onUltimaMensagem,
}: {
  onBack: () => void;
        ...
        <header className="wa-header">
          ...
          <div className="wa-header-left" onClick={() => setShowProfile(true)}>
            ...
            <div className="wa-header-info">
              <span className="wa-header-name">Mae ❤️</span>
          ...
          <div className="wa-profile">
            ...
            <div className="wa-profile-body">
              <div className="wa-profile-cover">
                ...
                <div className="wa-profile-name">Mae ❤️</div>
                <div className="wa-profile-sub">Familia</div>
              </div>
              <div className="wa-profile-section">
                <div className="wa-profile-section-label">Sobre</div>
                <div className="wa-profile-section-value">Te amo, filho</div>
              ...
              <div className="wa-profile-section">
                ...
                <div className="wa-profile-action" onClick={() => { setShowProfile(false); setShowGames(true); }}>
                  ...
                  <span className="wa-profile-action-text">Jogar com Mae ❤️</span>
                </div>
              </div>
        ...
        {callState !== "idle" && (
          <div className={`wa-call-overlay ${callState}`}>
            ...
            <div className="wa-call-content">
              ...
              <div className="wa-call-name">Mae ❤️</div>
