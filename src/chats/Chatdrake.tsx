...
import { respostasDrake } from "../respostasBot/respostasDrake";
...
const FOTOS = [
  resolveCloudAssetSrc("/imagens/timao.jfif"),
   resolveCloudAssetSrc("/imagens/timao1.jfif"),
  resolveCloudAssetSrc("/imagens/timao2.jfif"),
  resolveCloudAssetSrc("/imagens/timao3.jfif"),
  resolveCloudAssetSrc("/imagens/timao4.jfif"),
  resolveCloudAssetSrc("/imagens/timao5.jfif"),
...
const VIDEOS_CHAMADA = [
  "/videos/drake/video_1.mp4",
  "/videos/drake/video_2.mp4",
  "/videos/drake/video_3.mp4",
].map(resolveCloudAssetSrc);
...
// App principal
// ─────────────────────────────────────────────────────────────────────────────
export default function Chatdrake({
  onBack,
  onUltimaMensagem,
}: {
  onBack: () => void;
  ...
  // Enquanto estiver vazio, as respostas vêm sempre do banco local (respostasdrake.ts).
  const BACKEND_URL = "";
  ...
  async function sendMessage(text: string) {
    ...
    setTimeout(() => {
      const resposta = respostasDrake(text);
        ...
        <header className="wa-header">
          ...
          <div className="wa-header-left" onClick={() => setShowProfile(true)}>
            ...
            <div className="wa-header-info">
              <span className="wa-header-name">Timão & Pumba</span>
          ...
          <div className="wa-profile">
            ...
            <div className="wa-profile-body">
              <div className="wa-profile-cover">
                ...
                <div className="wa-profile-name">Timão & Pumba</div>
                <div className="wa-profile-sub">Amigo de faculdade</div>
              </div>
              <div className="wa-profile-section">
                <div className="wa-profile-section-label">Sobre</div>
                <div className="wa-profile-section-value">Gamer nas horas vagas, sempre pronto pra um role</div>
        ...
        {callState !== "idle" && (
          <div className={`wa-call-overlay ${callState}`}>
            ...
            <div className="wa-call-content">
              ...
              <div className="wa-call-name">Timão & Pumba</div>
